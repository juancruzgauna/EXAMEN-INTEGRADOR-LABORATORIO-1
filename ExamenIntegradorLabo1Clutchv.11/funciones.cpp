...
int determinarQuienEmpieza(string manoJugador[], string matrizSinMezclar[][4]){
    ...
    /*SE UTILIZARON MULTIPLOS DE 5 EN LOS ACUMULADORES
...
int tirardado()
{
    ...
    case 6:
        ...
        cout << "Elegir cualquiera de las acciones anteriores (1-5) o bien pasar el turno."<< endl;
        break;
    default:
...
void accionDado3(string manoJugadorQueNoEmpieza[], string manoJugadorQueEmpieza[], int cartaCorralPropio, int cartaCorralContrario, bool manoJugadorContrarioSinCartasBloqueadas[])
{
    ...
    cout << "Ingrese la carta del corral propio (1-5) para intercambiar por la del corral del contrario (1-5)" << endl << endl;
    ...
    while(cartaCorralPropio < 1 || cartaCorralPropio > 5)
    {
        ...
        cout << "Carta del corral propio: " << endl << endl;
        cin >> cartaCorralPropio;
    }
    cout << endl;
