...
int main()
{
    ...
    //int acumulador_puntosDeVictoriajugador1 = 0, acumulador_puntosDeVictoriajugador2 = 0;
    ...
    bool manoJugador2SinCartasBloqueadas[5] = {false};
        ...
        do
        {
            ...
            //SE DETERMINE SI ALGUNO DE LOS DOS GANÓ LA PARTIDA
        ...
        //INICIO EN CERO PORQUE NECESITO QUE SE RESETEE TRAS CADA PARTIDA
        int puntosDeVictoriaJugadorGanador;

        if(nombreJugadorGanador == jugador1)
        {
            puntosDeVictoriaJugadorGanador = puntosDeVictoriaQuienEmpieza + puntosDeVictoriaQuienNoEmpieza;
...
/*
        if(quienEmpieza == jugador1)
        {
            ...
            acumulador_puntosDeVictoriajugador1 += puntosDeVictoriaQuienEmpieza;

        }
        else if(quienNoEmpieza == jugador1)
        {
            puntosDeVictoriaJugadorGanador = puntosDeVictoriaQuienNoEmpieza;
            acumulador_puntosDeVictoriajugador2 += puntosDeVictoriaQuienEmpieza;
        }
        ...
        */
        ...
        /*
        if(puntajeVictoriaMaximo < acumulador_puntosDeVictoriajugador1){
            puntajeVictoriaMaximo = acumulador_puntosDeVictoriajugador1;
            ganadorMaximo = jugador1;
        }
        if(puntajeVictoriaMaximo < acumulador_puntosDeVictoriajugador2){
            puntajeVictoriaMaximo = acumulador_puntosDeVictoriajugador2;
            ganadorMaximo = jugador2;
        }
        if(acumulador_puntosDeVictoriajugador1 == acumulador_puntosDeVictoriajugador2){
            cout << "Ambos jugadores : " << jugador1 << " y " << jugador2 << " poseen la misma cantidad de puntos de victoria con " << acumulador_puntosDeVictoriajugador1 << " puntos." << endl;
        }
